...
test('ships a DSH client module bundle', async () => {
  ...
  assert.doesNotMatch(bundle, /Loading Column settings/)
  assert.doesNotMatch(bundle, /Enable the optional Review Column/)
  assert.match(bundle, /Show the Archive Column/)
  assert.match(bundle, /saveArchiveVisibility/)
  assert.doesNotMatch(bundle, /saveColumns/)
