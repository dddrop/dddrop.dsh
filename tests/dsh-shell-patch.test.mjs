...
test('ships a complete RC7 compact activity patch', async () => {
  ...
  assert.match(patch, /InputBar\.module\.css/)
  assert.match(patch, /PluginInventorySettingsTab\.module\.css/)
  ...
  assert.match(patch, /box-shadow: none/)
  assert.match(patch, /:global\(body\[data-ds-dark-theme\]\) \.detail/)
